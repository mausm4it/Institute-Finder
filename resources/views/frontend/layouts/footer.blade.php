<footer class="site-footer bg-blue-violet footer-default-style footer-style-one pd-b-60">
    <div class="waves-effect top" style="background: url('public/frontend/assets/images/shape/waves-footer.png');"></div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                ...
                <div class="col-12">
                    <div class="widget bt-instafeed-widget">
                        <ul id="instafeed">
                            ...
                            <li class="feed-item">
                                <a href="#">
                                    <img src="public/frontend/assets/images/widget/instagram/1/2.png" alt="#">
                                </a>
                            </li>
                            <li class="feed-item">
                                <a href="#">
                                    <img src="public/frontend/assets/images/widget/instagram/1/3.png" alt="#">
                                </a>
                            </li>
                            <li class="feed-item">
                                <a href="#">
                                    <img src="public/frontend/assets/images/widget/instagram/1/4.png" alt="#">
                                </a>
                            </li>
                            <li class="feed-item">
                                <a href="#">
                                    <img src="public/frontend/assets/images/widget/instagram/1/5.png" alt="#">
                                </a>
                            </li>
                            <li class="feed-item">
                                <a href="#">
                                    <img src="public/frontend/assets/images/widget/instagram/1/6.png" alt="#">
                                </a>
                            </li>
                            <li class="feed-item">
                                <a href="#">
                                    <img src="public/frontend/assets/images/widget/instagram/1/7.png" alt="#">
                                </a>
                            </li>
                            <li class="feed-item">
                                <a href="#">
