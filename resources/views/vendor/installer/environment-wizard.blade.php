    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="buttons">
                    <button class="button bg-color" onclick="showDatabaseSettings();return false">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="buttons">
                    <button class="button bg-color" onclick="showApplicationSettings();return false">
            ...
            <div class="tab" id="tab3content">
                ...
                <div class="buttons">
                    <button class="button bg-color" type="submit">
