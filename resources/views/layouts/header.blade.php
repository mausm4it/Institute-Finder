 ...
 <header class="app-header flex items-center px-4 gap-3">
     ...
     <div class="relative">
         ...
         <div
             ...
             <a href="javascript:void(0);"
                 ...
                 <img src="public/assets/images/flags/germany.jpg" alt="user-image" class="h-4">
             ...
             <a href="javascript:void(0);"
                 class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                 <img src="public/assets/images/flags/italy.jpg" alt="user-image" class="h-4">
             ...
             <a href="javascript:void(0);"
                 class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                 <img src="public/assets/images/flags/spain.jpg" alt="user-image" class="h-4">
             ...
             <a href="javascript:void(0);"
                 class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                 <img src="public/assets/images/flags/russia.jpg" alt="user-image" class="h-4">
             ...
             <div class="p-4 h-80" data-simplebar>
                 ...
                 <a href="javascript:void(0);" class="block mb-4">
                     <div class="card-body">
                         <div class="flex items-center">
                             <div class="flex-shrink-0">
                                 <img src="public/assets/images/users/avatar-2.jpg" class="rounded-full h-9 w-9"
                                     alt="">
                             </div>
                             <div class="flex-grow truncate ms-2">
                 ...
                 <a href="javascript:void(0);" class="block">
                     <div class="card-body">
                         <div class="flex items-center">
                             <div class="flex-shrink-0">
                                 <img src="public/assets/images/users/avatar-4.jpg" class="rounded-full h-9 w-9"
                                     alt="">
                             </div>
                             <div class="flex-grow truncate ms-2">
     ...
     <div class="relative">
         <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link">
             <img src="public/assets/images/users/user-6.jpg" alt="user-image" class="rounded-full h-10">
         </button>
         <div
