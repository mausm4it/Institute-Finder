...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">User Contact</h4>
        ...
        <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('user_contact') }}" class="text-sm font-medium text-slate-700 dark:text-slate-400"
                    aria-current="page">User Contact</a>
            </div>
        </div>
    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="flex justify-end items-center gap-4 p-4 ">
                                                ...
                                                <a href="{{ route('delete-user_contact', $item->id) }}" type="submit"
