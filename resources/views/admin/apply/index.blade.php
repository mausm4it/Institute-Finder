...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Apply</h4>
        ...
        <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('apply_list') }}" class="text-sm font-medium text-slate-700 dark:text-slate-400"
    ...
    <div class="relative overflow-x-auto">
        <table class="w-full divide-y divide-gray-300 dark:divide-gray-700">
            <thead class="bg-slate-300 bg-opacity-20 border-t dark:bg-slate-800 divide-gray-300 dark:border-gray-700">
                <tr>
                    <th scope="col"
                        class="py-3.5 ps-4 pe-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-200">Name
                    </th>
                    ...
                    @if (auth()->user()->can('update apply') or auth()->user()->can('delete apply'))
                        <th scope="col"
                ...
                @isset($applies)
                    @foreach ($applies as $item)
                        <tr>
                            ...
                            <td class="whitespace-nowrap py-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200">
                                {{ Str::limit($item->college->name, 30, $end = '...') }}</td>
                            <td class="whitespace-nowrap py-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200">
                                {{ Str::limit($item->course->name, 30, $end = '...') }}</td>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="flex justify-end items-center gap-4 p-4 ">
                                                    ...
                                                    <a href="{{ route('delete-apply', $item->id) }}" type="submit"
