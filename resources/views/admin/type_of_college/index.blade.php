...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Type of Colleges</h4>
        ...
        <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('type-of-college') }}" class="text-sm font-medium text-slate-700 dark:text-slate-400"
                    aria-current="page">Type of College</a>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                <a href="javascript:void(0);"
                    ...
                    data-fc-type="modal" data-fc-target="createtype-of-college"><i class="mgc_add_circle_line me-3"></i> Add
                    Type of College</a>



                <div id="createtype-of-college"
                    ...
                    <div
                        ...
                        <div class="px-4 py-8 overflow-y-auto">
                            <form action="{{ route('create-type-of-college') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="name"
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="px-4 py-8 overflow-y-auto">
                                                        <form action="{{ route('update-type-of-college', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="mb-3">
                                                                <label for="name"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex justify-end items-center gap-4 p-4 ">
                                                        ...
                                                        <a href="{{ route('delete-type-of-college', $item->id) }}"
